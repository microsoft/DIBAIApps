...
- Integration Guides: Step-by-step instructions for connecting AI services with existing workflows.
- Compliance-Ready Templates: Architectures aligned with FedRAMP High and DoD security standards.
...
git clone https://github.com/microsoft/DIBAIApps.git
```